                ...
                <tbody>
                  <tr className="bg-white border-b drk:bg-gray-800 drk:border-gray-700">
                    ...
                    <td className="py-4 px-6">
                      ...
                      <button type="button" className="focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg px-3 py-2.5 mr-2 mb-2 drk:focus:ring-yellow-900">
