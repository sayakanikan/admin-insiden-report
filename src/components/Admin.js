    ...
    <div>
      ...
      <div className="flex">
        ...
        <div className="w-full md:w-[81%] px-7 md:px-10 py-7 bg-gray-50 drk:bg-slate-700">
          ...
          {/* Add & Search Input */}
          <div className="flex mb-4 justify-between mr-14 md:mr-0">
            ...
            <button className="relative items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-cyan-500 to-blue-500 group-hover:from-cyan-500 group-hover:to-blue-500 hover:text-white drk:text-white focus:ring-4 focus:outline-none focus:ring-cyan-200 drk:focus:ring-cyan-800 hidden md:inline-flex">
            ...
            <button className="relative items-center justify-center py-3 px-4 mb-2 overflow-hidden text-sm font-medium text-white rounded-lg group bg-gradient-to-br from-cyan-500 to-blue-500 group-hover:from-cyan-500 group-hover:to-blue-500 hover:text-white drk:text-white focus:ring-4 focus:outline-none focus:ring-cyan-200 drk:focus:ring-cyan-800 inline-flex md:hidden">
